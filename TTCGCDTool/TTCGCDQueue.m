...
static TTCGCDQueue *mainQueue;
static TTCGCDQueue *globalQueue;
static TTCGCDQueue *highPriorityGlobalQueue;
static TTCGCDQueue *lowPriorityGlobalQueue;
static TTCGCDQueue *backgroundPriorityGlobalQueue;

@interface TTCGCDQueue ()

@property (strong, readwrite, nonatomic) dispatch_queue_t dispatchQueue;//!<读写队列

@end

@implementation TTCGCDQueue

+ (TTCGCDQueue *)mainQueue {
...
+ (void)initialize {
     ...
     */
    if (self == [TTCGCDQueue self])  {
        
        mainQueue                     = [TTCGCDQueue new];
        globalQueue                   = [TTCGCDQueue new];
        highPriorityGlobalQueue       = [TTCGCDQueue new];
        lowPriorityGlobalQueue        = [TTCGCDQueue new];
        backgroundPriorityGlobalQueue = [TTCGCDQueue new];
